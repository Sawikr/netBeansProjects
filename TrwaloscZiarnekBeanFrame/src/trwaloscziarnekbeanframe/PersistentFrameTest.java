package trwaloscziarnekbeanframe;
...
public class PersistentFrameTest
{
   ...
   public void init()
   {
      ...
      loadButton.addActionListener(EventHandler.create(ActionListener.class, this, "load"));// load to nazwa metody
